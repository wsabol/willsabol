    ...
    <div className="container has-text-centered">
      <div className="columns is-centered">
        <div className="buttons">
          <a className="button is-medium is-rounded" href="https://minds.com/willsabol" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon="brain" />
          </a>
          <a className="button is-medium is-rounded" href="https://www.linkedin.com/in/will-sabol" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={['fab', 'linkedin-in']} />
          </a>
          <a className="button is-medium is-rounded" href="https://github.com/wsabol" target="_blank" rel="noopener noreferrer">
            <FontAwesomeIcon icon={['fab', 'github']} />
          </a>
          <a className="button is-medium is-rounded" href="mailto:hello@jethromay.com" target="_blank" rel="noopener noreferrer">
